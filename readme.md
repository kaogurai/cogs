...
|--------------|---------|-----------------------------------------------------------------------------------|
| AIArt        | v1.14.15 | Generate incredible art using AI.                                                |
...
| OCR          | v1.0.1  | Converts images to text.                                                          |
| Radio        | v1.0.3  | Saves radio URLs for easy access.                                                 |
| SFX          | v6.0.2  | Allow users to play TTS, SFX, and Join/Leave sounds. (originally made by baiumbg) |
| SmartLyrics  | v2.1.1  | Gets lyrics for your current song.                                                |
