...
class AntiNSFW(commands.Cog):
    ...
    async def status(self, ctx):
        ...
        requirement = str(int(await self.config.guild(ctx.guild).requirement() * 100)) + '%'
        if await self.config.guild(ctx.guild).enabled() is True:
            embed.add_field(name="Module Enabled", value='<:toggle_on:823619123438551070>', inline=False)
        else:
            embed.add_field(name="Module Enabled", value='<:toggle_off:823619122872975364>', inline=False)
        ...
        if await self.config.guild(ctx.guild).active_in_nsfw_channels() is True:
            if await self.config.guild(ctx.guild).enabled() is True:
                embed.add_field(name="Filtering NSFW Channels", value='<:toggle_on:823619123438551070>', inline=False)
            else:
                embed.add_field(name="Filtering NSFW Channels", value='<:toggle_on:823619123438551070> (Module Disabled)', inline=False)
        else:
            embed.add_field(name="Filtering NSFW Channels", value='<:toggle_off:823619122872975364>', inline=False)
        if await self.config.guild(ctx.guild).filter_media() is True:
            if await self.config.guild(ctx.guild).enabled() is True:
                embed.add_field(name="Filtering Media", value='<:toggle_on:823619123438551070>', inline=False)
            else:
                embed.add_field(name="Filtering Media", value='<:toggle_on:823619123438551070> (Module Disabled)', inline=False)
        else:
            embed.add_field(name="Filtering Media", value='<:toggle_off:823619122872975364>', inline=False)
        if await self.config.guild(ctx.guild).filter_emotes() is True:
            if await self.config.guild(ctx.guild).enabled() is True:
                embed.add_field(name="Filtering Emotes", value='<:toggle_on:823619123438551070>', inline=False)
            else:
                embed.add_field(name="Filtering Emotes", value='<:toggle_on:823619123438551070> (Module Disabled)', inline=False)
        else:
            embed.add_field(name="Filtering Emotes", value='<:toggle_off:823619122872975364>', inline=False)
        if await self.config.guild(ctx.guild).filter_links() is True:
            if await self.config.guild(ctx.guild).enabled() is True:
                embed.add_field(name="Filtering Links", value='<:toggle_on:823619123438551070>', inline=False)
            else:
                embed.add_field(name="Filtering Links", value='<:toggle_on:823619123438551070> (Module Disabled)', inline=False)
        else:
            embed.add_field(name="Filtering Links", value='<:toggle_off:823619122872975364>', inline=False)
        if await self.config.guild(ctx.guild).ignored_channels():
            ...
            embed.add_field(name="Ignored Channels", value=formatted_ignored_channels, inline=False)
        if await self.config.guild(ctx.guild).ignored_roles():
            ...
            embed.add_field(name="Ignored Roles", value=formatted_ignored_roles, inline=False)
