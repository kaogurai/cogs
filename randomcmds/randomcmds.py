...
class Randomcmds(commands.Cog):
    ...
    async def asia(self, ctx):
       ctx.send("asia is the best person on this earth and loves videos of emo kids dancing")
       ctx.send("https://cdn.discordapp.com/attachments/768663090337677315/795133511673053225/emokidsyummy.mp4")
