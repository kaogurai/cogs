"""
This entire file is copied from https://raw.githubusercontent.com/TrustyJAID/Trusty-cogs/master/notsobot/converter.py

This is licensed under the MIT license, which can be found in the LICENSE file of the above repository.
"""
